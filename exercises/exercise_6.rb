...
@store2.employees.create(first_name: "Kevin", last_name: "ZiFeng", hourly_rate: 30)
@store2.employees.create(first_name: "HoHo", last_name: "Hoang", hourly_rate: 40)
@store2.employees.create(first_name: "Nick", last_name: "Danvers", hourly_rate: 30)

@store4 = Store.find_by(id: 4)
@store4.employees.create(first_name: "Elissa", last_name: "M", hourly_rate: 80)
@store4.employees.create(first_name: "Olivia", last_name: "Power", hourly_rate: 30)
